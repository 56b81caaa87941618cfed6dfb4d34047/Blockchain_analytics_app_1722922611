...
*/
Vue.component("simple_hero_component_1722922612", {
    template: `
        <section id="hero-section" class="bg-gradient-to-r from-pink-500 to-purple-600 flex-1">
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7 bg-white bg-opacity-20 rounded-lg backdrop-filter backdrop-blur-lg shadow-lg p-6">
                    ...
                    <div id="hero-subtitle-container" class="flex">
                        <p id="hero-subtitle" class="flex-1 max-w-2xl mb-6 font-light text-white lg:mb-8 md:text-lg lg:text-xl">Gain Valuable Insights from the Latest Blockchain Data</p>
                    </div>
