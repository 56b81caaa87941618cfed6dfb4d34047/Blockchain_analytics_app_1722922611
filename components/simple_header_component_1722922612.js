...
Vue.component("simple_header_component_1722922612", {
    template: `
    <header id="header-section" class="w-full">
        <nav id="nav-bar" class="bg-pink-600 bg-opacity-30 backdrop-filter backdrop-blur-lg border-gray-200 py-2.5 dark:bg-purple-900 dark:bg-opacity-30 shadow-lg">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a id="logo-link" href="#" class="flex items-center">
                    ...
                    <span id="app-name" class="self-center text-xl font-semibold whitespace-nowrap text-white">BlockChain Analytics</span>
                </a>
                <div id="menu-toggle-button" class="flex items-center lg:order-2">
                    <button id="collapse-button" data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-white rounded-lg lg:hidden hover:bg-pink-400 hover:bg-opacity-30 focus:outline-none focus:ring-2 focus:ring-pink-300 dark:text-white dark:hover:bg-purple-700 dark:focus:ring-purple-600" aria-controls="mobile-menu-2" aria-expanded="false">
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-white bg-pink-500 bg-opacity-50 rounded-lg lg:bg-transparent lg:text-pink-300 lg:p-0 hover:bg-pink-400 hover:bg-opacity-30" aria-current="page">Real-time Blockchain Monitoring</a></li>
                        <li id="nav-item-1"><a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-pink-400 hover:bg-opacity-30 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-300 lg:p-0 dark:text-white lg:dark:hover:text-pink-300 dark:hover:bg-purple-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Comprehensive Transaction Analysis</a></li>
